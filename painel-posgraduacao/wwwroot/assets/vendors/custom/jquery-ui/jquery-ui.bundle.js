! function(t) {
    ...
    function t() {
        this._curInst = null, this._keyEvent = !1, this._disabledInputs = [], this._datepickerShowing = !1, this._inDialog = !1, this._mainDivId = "ui-datepicker-div", this._inlineClass = "ui-datepicker-inline", this._appendClass = "ui-datepicker-append", this._triggerClass = "ui-datepicker-trigger", this._dialogClass = "ui-datepicker-dialog", this._disableClass = "ui-datepicker-disabled", this._unselectableClass = "ui-datepicker-unselectable", this._currentClass = "ui-datepicker-current-day", this._dayOverClass = "ui-datepicker-days-cell-over", this.regional = [], this.regional[""] = {
            ...
            autoSize: !1,
            disabled: !1
        }, I.extend(this._defaults, this.regional[""]), this.regional.en = I.extend(!0, {}, this.regional[""]), this.regional["en-US"] = I.extend(!0, {}, this.regional.en), this.dpDiv = i(I("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
    }
    ...
    I.cleanData = (n = I.cleanData, function(t) {
            ...
            return e || (e = i, i = I.Widget), I.isArray(e) && (e = I.extend.apply(null, [{}].concat(e))), I.expr[":"][h.toLowerCase()] = function(t) {
                ...
                return I.isFunction(o) ? void(a[e] = function() {
                    function s() {
            ...
            for (var e, i, s = r.call(arguments, 1), n = 0, o = s.length; n < o; n++)
                for (e in s[n]) i = s[n][e], s[n].hasOwnProperty(e) && void 0 !== i && (t[e] = I.isPlainObject(i) ? I.isPlainObject(t[e]) ? I.widget.extend({}, t[e], i) : I.widget.extend({}, i) : i);
            return t
            ...
            _createWidget: function(t, e) {
                e = I(e || this.defaultElement || this)[0], this.element = I(e), this.uuid = a++, this.eventNamespace = "." + this.widgetName + this.uuid, this.bindings = I(), this.hoverable = I(), this.focusable = I(), this.classesElementLookup = {}, e !== this && (I.data(e, this.widgetFullName, this), this._on(!0, this.element, {
                    remove: function(t) {
            ...
            _on: function(a, r, t) {
                ...
                "boolean" != typeof a && (t = r, r = a, a = !1), t ? (r = h = I(r), this.bindings = this.bindings.add(r)) : (t = r, r = this.element, h = this.widget()), I.each(t, function(t, e) {
                    function i() {
                        return a || !0 !== l.options.disabled && !I(this).hasClass("ui-state-disabled") ? ("string" == typeof e ? l[e] : e).apply(l, arguments) : void 0
                    }
            ...
            I.position = {
                ...
                return t = 9 === (i = (e = _)[0]).nodeType ? {
                    ...
                    var i, t, a = I(this),
                        ...
                        e = x(this, "marginLeft"),
                        s = x(this, "marginTop"),
                        n = r + e + x(this, "marginRight") + b.width,
                        o = h + s + x(this, "marginBottom") + b.height,
                        l = I.extend({}, m),
                    ...
                    "right" === u.my[0] ? l.left -= r : "center" === u.my[0] && (l.left -= r / 2), "bottom" === u.my[1] ? l.top -= h : "center" === u.my[1] && (l.top -= h / 2), l.left += c[0], l.top += c[1], i = {
                        ...
                        p < r && p > D(e + i) && (o.horizontal = "center"), f < h && f > D(s + n) && (o.vertical = "middle"), o.important = C(D(e), D(i)) > C(D(s), D(n)) ? "horizontal" : "vertical", u.using.call(this, t, o)
                    }), a.offset(I.extend(l, {
                        using: t
                    }))
                })
                ...
                fit: {
                    left: function(t, e) {
                        ...
                        e.collisionWidth > o ? 0 < r && h <= 0 ? (i = t.left + r + e.collisionWidth - o - n, t.left += r - i) : t.left = 0 < h && r <= 0 ? n : h < r ? n + o - e.collisionWidth : n : 0 < r ? t.left += r : 0 < h ? t.left -= h : t.left = C(t.left - a, t.left)
                    },
                    top: function(t, e) {
                        var i, s = e.within,
                        ...
                        e.collisionHeight > o ? 0 < r && h <= 0 ? (i = t.top + r + e.collisionHeight - o - n, t.top += r - i) : t.top = 0 < h && r <= 0 ? n : h < r ? n + o - e.collisionHeight : n : 0 < r ? t.top += r : 0 < h ? t.top -= h : t.top = C(t.top - a, t.top)
                    }
                },
                flip: {
                    left: function(t, e) {
                        var i, s, n = e.within,
                            ...
                            p = -2 * e.offset[0];
                        l < 0 ? ((i = t.left + u + d + p + e.collisionWidth - a - o) < 0 || D(l) > i) && (t.left += u + d + p) : 0 < c && ((0 < (s = t.left - e.collisionPosition.marginLeft + u + d + p - r) || c > D(s)) && (t.left += u + d + p))
                    },
                    top: function(t, e) {
                        var i, s, n = e.within,
                            ...
                            p = -2 * e.offset[1];
                        l < 0 ? ((s = t.top + u + d + p + e.collisionHeight - a - o) < 0 || D(l) > s) && (t.top += u + d + p) : 0 < c && ((0 < (i = t.top - e.collisionPosition.marginTop + u + d + p - r) || c > D(i)) && (t.top += u + d + p))
                    }
                },
                flipfit: {
                    left: function() {
    ...
    I.effects = {
        ...
        function(c, u) {
            ...
            function r(a) {
                var r = f(),
                    h = r._rgba = [];
                return a = a.toLowerCase(), _(t, function(t, e) {
                    var i, s = e.re.exec(a),
                        n = s && e.parse(s),
                        o = e.space || "rgba";
            ...
            var l, p = /^([\-+])=\s*(\d+\.?\d*)/,
                ...
                e = c("<p>")[0],
                _ = c.each;
            e.style.cssText = "background-color:rgba(1,1,1,.5)", a.rgba = -1 < e.style.backgroundColor.indexOf("rgba"), _(g, function(t, e) {
                ...
                parse: function(n, t, e, i) {
                    ...
                    return t !== u && (n = [n, t, e, i], s = "array"), "string" === s ? this.parse(r(n) || l._default) : "array" === s ? (_(g.rgba.props, function(t, e) {
                        a[e.idx] = d(n[e.idx], e)
                    }), this) : "object" === s ? (_(g, n instanceof f ? function(t, e) {
                ...
                f.fn[h] = function(t) {
                    ...
                    f.fn[a] || (f.fn[a] = function(t) {
                        var e, i = c.type(t),
                            ...
                            n = this[s](),
                            o = n[r.idx];
                        return "undefined" === i ? o : ("function" === i && (t = t.call(this, o), i = c.type(t)), null == t && r.empty ? this : ("string" === i && ((e = p.exec(t)) && (t = o + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1))), n[r.idx] = t, this[s](n)))
                    })
                })
            }), f.hook = function(t) {
                var e = t.split(" ");
        ...
        function() {
            ...
            I.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function(t, e) {
                ...
                return this.queue(function() {
                    ...
                    s = s.map(function() {
                        ...
                        return this.end = a(this.el[0]), this.diff = function(t, e) {
                            var i, s, n = {};
                            for (i in e) s = e[i], t[i] !== s && (l[i] || (I.fx.step[i] || !isNaN(parseFloat(s))) && (n[i] = s));
                            return n
                ...
                addClass: (r = I.fn.addClass, function(t, e, i, s) {
                    return e ? I.effects.animateClass.call(this, {
                        add: t
                    }, e, i, s) : r.apply(this, arguments)
                }),
        ...
        function() {
            ...
            var s, n, o, a;
            I.expr && I.expr.filters && I.expr.filters.animated && (I.expr.filters.animated = (a = I.expr.filters.animated, function(t) {
                return !!I(t).data(p) || a(t)
                ...
                effect: function() {
                    function t(t) {
                        function e() {
                            I.isFunction(a) && a.call(i[0]), I.isFunction(t) && t()
                        }
                        var i = I(this);
                        s.mode = h.shift(), !1 === I.uiBackCompat || o ? "none" === s.mode ? (i[r](), e()) : n.call(i[0], s, function() {
                            i.removeData(p), I.effects.cleanUp(i), "hide" === s.mode && i.hide(), e()
                        }) : (i.is(":hidden") ? "hide" === r : "show" === r) ? (i[r](), e()) : n.call(i[0], s, e)
                    }
                    var s = c.apply(this, arguments),
                        ...
                        l = function(t) {
                            ...
                            e.data(p, !0), h.push(i), o && ("show" === i || i === o && "hide" === i) && e.show(), o && "none" === i || I.effects.saveStyle(e), I.isFunction(t) && t()
                        };
                    return I.fx.off || !n ? r ? this[r](s.duration, a) : this.each(function() {
                        a && a.call(this)
                    }) : !1 === e ? this.each(l).each(t) : this.queue(i, l).queue(i, t)
                },
                show: (o = I.fn.show, function(t) {
                    if (i(t)) return o.apply(this, arguments);
                    var e = c.apply(this, arguments);
                    return e.mode = "show", this.effect.call(this, e)
                }),
                hide: (n = I.fn.hide, function(t) {
                    if (i(t)) return n.apply(this, arguments);
                    var e = c.apply(this, arguments);
                    return e.mode = "hide", this.effect.call(this, e)
                }),
                toggle: (s = I.fn.toggle, function(t) {
        ...
        }(), h = {}, I.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function(e, t) {
            h[t] = function(t) {
    ...
    I.effects.define("blind", "hide", function(t, e) {
        ...
        var s, n, o, a, r, h, l = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3,
            c = l,
            u = I(this),
            d = "show" === t.mode,
        ...
        TAB: 9,
        UP: 38
    }, I.ui.escapeSelector = (g = /([!"#$%&'()*+,.\/:;<=>?@[\]^`{|}~])/g, function(t) {
            ...
            this.isMultiLine = e || !o && this._isContentEditable(this.element), this.valueMethod = this.element[e || o ? "val" : "text"], this.isNewMenu = !0, this._addClass("ui-autocomplete-input"), this.element.attr("autocomplete", "off"), this._on(this.element, {
                ...
                menufocus: function(t, e) {
                    ...
                    return this.isNewMenu && (this.isNewMenu = !1, t.originalEvent && /^mouse/.test(t.originalEvent.type)) ? (this.menu.blur(), void this.document.one("mousemove", function() {
                        ...
                        item: s
                    }) && t.originalEvent && /^key/.test(t.originalEvent.type) && this._value(s.value), void((i = e.item.attr("aria-label") || s.value) && I.trim(i).length && (this.liveRegion.children().hide(), I("<div>").text(i).appendTo(this.liveRegion))))
                },
    ...
    I.widget("ui.controlgroup", {
        ...
        _resolveClassesValues: function(i, s) {
            ...
            return I.each(i, function(t) {
                ...
                e = I.trim(e.replace(v, "")), n[t] = (e + " " + i[t]).replace(/\s+/g, " ")
            }), n
        },
        _setOption: function(t, e) {
    ...
    }), I.fn.button = (m = I.fn.button, function() {
        return !this.length || this.length && "INPUT" !== this[0].tagName || this.length && "INPUT" === this[0].tagName && "checkbox" !== this.attr("type") && "radio" !== this.attr("type") ? m.apply(this, arguments) : (I.ui.checkboxradio || I.error("Checkboxradio widget missing"), 0 === arguments.length ? this.checkboxradio({
            icon: !1
        ...
        _newInst: function(t, e) {
            return {
                ...
                drawYear: 0,
                inline: e,
                dpDiv: e ? i(I("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>")) : this.dpDiv
            }
        },
        ...
        _dialogDatepicker: function(t, e, i, s, n) {
            ...
            return c || (this.uuid += 1, o = "dp" + this.uuid, this._dialogInput = I("<input type='text' id='" + o + "' style='position: absolute; top: -100px; width: 0px;'/>"), this._dialogInput.on("keydown", this._doKeyDown), I("body").append(this._dialogInput), (c = this._dialogInst = this._newInst(this._dialogInput, !1)).settings = {}, I.data(this._dialogInput[0], "datepicker", c)), u(c.settings, s || {}), e = e && e.constructor === Date ? this._formatDate(c, e) : e, this._dialogInput.val(e), this._pos = n ? n.length ? n : [n.pageX, n.pageY] : null, this._pos || (a = document.documentElement.clientWidth, r = document.documentElement.clientHeight, h = document.documentElement.scrollLeft || document.body.scrollLeft, l = document.documentElement.scrollTop || document.body.scrollTop, this._pos = [a / 2 - 100 + h, r / 2 - 150 + l]), this._dialogInput.css("left", this._pos[0] + 20 + "px").css("top", this._pos[1] + "px"), c.settings.onSelect = i, this._inDialog = !0, this.dpDiv.addClass(this._dialogClass), this._showDatepicker(this._dialogInput[0]), I.blockUI && I.blockUI(this.dpDiv), I.data(this._dialogInput[0], "datepicker", c), this
        },
        ...
        _doKeyPress: function(t) {
            ...
            return I.datepicker._get(s, "constrainInput") ? (e = I.datepicker._possibleChars(I.datepicker._get(s, "dateFormat")), i = String.fromCharCode(null == t.charCode ? t.keyCode : t.charCode), t.ctrlKey || t.metaKey || i < " " || !e || -1 < e.indexOf(i)) : void 0
        },
        _doKeyUp: function(t) {
        ...
        parseDate: function(i, o, t) {
            ...
            if (-1 === f ? f = (new Date).getFullYear() : f < 100 && (f += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (f <= l ? 0 : -100)), -1 < _)
                for (g = 1, m = _; !(m <= (e = this._getDaysInMonth(f, g - 1)));) g++, m -= e;
        ...
        _generateMonthYearHeader: function(t, e, i, s, n, o, a, r) {
            ...
            if (o || !m) y += "<span class='ui-datepicker-month'>" + a[e] + "</span>";
                ...
                for (h = s && s.getFullYear() === i, l = n && n.getFullYear() === i, y += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>", c = 0; c < 12; c++)(!h || c >= s.getMonth()) && (!l || n.getMonth() >= c) && (y += "<option value='" + c + "'" + (c === e ? " selected='selected'" : "") + ">" + r[c] + "</option>");
                y += "</select>"
            }
    ...
    }, I.datepicker = new t, I.datepicker.initialized = !1, I.datepicker.uuid = (new Date).getTime(), I.datepicker.version = "1.12.1", I.datepicker, I.ui.ie = !!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase());
    var b = !1;
    I(document).on("mouseup", function() {
        ...
        _mouseDown: function(t) {
            if (!b) {
                ...
                return i && !s && this._mouseCapture(t) && (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function() {
                    e.mouseDelayMet = !0
                }, this.options.delay)), this._mouseDistanceMet(t) && this._mouseDelayMet(t) && (this._mouseStarted = !1 !== this._mouseStart(t), !this._mouseStarted) ? t.preventDefault() : (!0 === I.data(t.target, this.widgetName + ".preventClickEvent") && I.removeData(t.target, this.widgetName + ".preventClickEvent"), this._mouseMoveDelegate = function(t) {
        ...
        _mouseUp: function(t) {
            this.document.off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, t.target === this._mouseDownEvent.target && I.data(t.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(t)), this._mouseDelayTimer && (clearTimeout(this._mouseDelayTimer), delete this._mouseDelayTimer), this.ignoreMissingWhich = !1, b = !1, t.preventDefault()
        },
        ...
        drag: function(t, e, i) {
            ...
            })), i.snapElements[u].snapping = !1) : ("inner" !== p.snapMode && (s = f >= Math.abs(l - v), n = f >= Math.abs(c - _), o = f >= Math.abs(r - m), a = f >= Math.abs(h - g), s && (e.position.top = i._convertPositionTo("relative", {
    ...
    }), I.ui.draggable, I.widget("ui.resizable", I.ui.mouse, {
        version: "1.12.1",
        ...
        _setupHandles: function() {
            ...
            if (this.handles = o.handles || (I(".ui-resizable-handle", this.element).length ? {
                ...
                for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), i = this.handles.split(","), this.handles = {}, e = 0; i.length > e; e++) s = "ui-resizable-" + (t = I.trim(i[e])), n = I("<div>"), this._addClass(n, "ui-resizable-handle " + s), n.css({
                    zIndex: o.zIndex
    ...
    }), I.ui.resizable, I.widget("ui.dialog", {
        version: "1.12.1",
        options: {
            appendTo: "body",
            autoOpen: !0,
        ...
        _createButtons: function() {
            ...
            return this.uiDialogButtonPane.remove(), this.uiButtonSet.empty(), I.isEmptyObject(t) || I.isArray(t) && !t.length ? void this._removeClass(this.uiDialog, "ui-dialog-buttons") : (I.each(t, function(t, e) {
                var i, s;
                e = I.isFunction(e) ? {
                    click: e,
                    text: t
    ...
    }), I.ui.dialog, I.widget("ui.droppable", {
        version: "1.12.1",
        ...
        _drop: function(e, t) {
            ...
            return !(!i || (i.currentItem || i.element)[0] === this.element[0]) && (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function() {
                ...
                return t.options.greedy && !t.options.disabled && t.options.scope === i.options.scope && t.accept.call(t.element[0], i.currentItem || i.element) && w(i, I.extend(t, {
    ...
    var y, w = I.ui.intersect = function() {
        function d(t, e, i) {
            return e <= t && t < e + i
        }
    ...
    !(I.ui.ddmanager = {
        ...
        drag: function(o, a) {
            o.options.refreshPositions && I.ui.ddmanager.prepareOffsets(o, a), I.each(I.ui.ddmanager.droppables[o.options.scope] || [], function() {
                if (!this.options.disabled && !this.greedyChild && this.visible) {
                    var t, e, i, s = w(o, this, this.options.tolerance, a),
        ...
        _getItemsAsjQuery: function(t) {
            ...
            if (h && t)
                for (i = h.length - 1; 0 <= i; i--)
                    for (s = (n = I(h[i], this.document[0])).length - 1; 0 <= s; s--)(o = I.data(n[s], this.widgetFullName)) && o !== this && !o.options.disabled && r.push([I.isFunction(o.options.items) ? o.options.items.call(o.element) : I(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), o]);
            for (r.push([I.isFunction(this.options.items) ? this.options.items.call(this.element, null, {
                    options: this.options,
                    item: this.currentItem
                }) : I(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), this]), i = r.length - 1; 0 <= i; i--) r[i][0].each(e);
            return I(a)
        },
        ...
        _contactContainers: function(t) {
            ...
            if (u)
                if (1 === this.containers.length) this.containers[d].containerCache.over || (this.containers[d]._trigger("over", t, this._uiHash(this)), this.containers[d].containerCache.over = 1);
                    ...
                    for (s = 1e4, n = null, o = (l = u.floating || this._isFloating(this.currentItem)) ? "left" : "top", a = l ? "width" : "height", c = l ? "pageX" : "pageY", i = this.items.length - 1; 0 <= i; i--) I.contains(this.containers[d].element[0], this.items[i].item[0]) && this.items[i].item[0] !== this.currentItem[0] && (r = this.items[i].item.offset()[o], h = !1, t[c] - r > this.items[i][a] / 2 && (h = !0), s > Math.abs(t[c] - r) && (s = Math.abs(t[c] - r), n = this.items[i], this.direction = h ? "up" : "down"));
        ...
        _events: {
            ...
            "mousedown .ui-spinner-button": function(t) {
                function e() {
                    this.element[0] === I.ui.safeActiveElement(this.document[0]) || (this.element.trigger("focus"), this.previous = i, this._delay(function() {
                        this.previous = i
                    }))
                }
                var i;
        ...
        _create: function() {
            ...
            }))).sort()), this.active = !1 !== this.options.active && this.anchors.length ? this._findActive(t.active) : I(), this._refresh(), this.active.length && this.load(t.active)
        },
        ...
        _findNextTab: function(t, e) {
            for (var i = this.tabs.length - 1; - 1 !== I.inArray((i < t && (t = 0), t < 0 && (t = i), t), this.options.disabled);) t = e ? t + 1 : t - 1;
            return t
        },
